...
/**
 * Provides an exhaustive list of mocked {@link CommandObject}s for use in unit tests.
 */
...
public abstract class MockedCommandObjectsTestBase {
  ...
  @Mock protected CommandObject<ScanResult<Entry<String, String>>> scanResultEntryStringStringCommandObject;
