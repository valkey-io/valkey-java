...
public class SortedSetPipelineCommandsTest extends PipelineCommandsTestBase {
  ...
  public void zscan() {
    ...
    Response<ScanResult<Tuple>> result = pipe.zscan("foo", ScanParams.SCAN_POINTER_START);
    ...
    Response<ScanResult<Tuple>> bResult = pipe.zscan(bfoo, ScanParams.SCAN_POINTER_START_BINARY);
  ...
  public void zscanMatch() {
    ...
    pipe.zadd("foo", 1, "a");
    pipe.zadd("foo", 11, "aa");
    Response<ScanResult<Tuple>> result = pipe.zscan("foo", ScanParams.SCAN_POINTER_START, params);
    ...
    Response<ScanResult<Tuple>> bResult = pipe.zscan(bfoo, ScanParams.SCAN_POINTER_START_BINARY, params);
