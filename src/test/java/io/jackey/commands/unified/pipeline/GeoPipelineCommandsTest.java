package io.jackey.commands.unified.pipeline;
...
import io.jackey.util.GeoCoordinateMatcher;
...
public class GeoPipelineCommandsTest extends PipelineCommandsTestBase {
  ...
  public void geohash() {
    ...
    MatcherAssert.assertThat(bhashes.get(), Matchers.contains(
  ...
  public void geopos() {
    ...
    MatcherAssert.assertThat(coordinates.get(), Matchers.contains(
        GeoCoordinateMatcher.atCoordinates(3.0, 4.0),
        GeoCoordinateMatcher.atCoordinates(2.0, 3.0),
        null
    ));

    MatcherAssert.assertThat(bcoordinates.get(), Matchers.contains(
        GeoCoordinateMatcher.atCoordinates(3.0, 4.0),
        GeoCoordinateMatcher.atCoordinates(2.0, 3.0),
        null
    ));
  ...
  public void georadius() {
    ...
    MatcherAssert.assertThat(members4.get().stream().map(GeoRadiusResponse::getCoordinate).collect(Collectors.toList()),
        Matchers.contains(GeoCoordinateMatcher.atCoordinates(15.087269, 37.502669)));
  ...
  public void georadiusByMember() {
    ...
    assertThat(members3.get().stream().map(GeoRadiusResponse::getDistance).collect(Collectors.toList()),
        contains(closeTo(0.0, EPSILON)));
    MatcherAssert.assertThat(members3.get().stream().map(GeoRadiusResponse::getCoordinate).collect(Collectors.toList()),
        Matchers.contains(GeoCoordinateMatcher.atCoordinates(13.583333, 37.316667)));
    assertThat(members3.get().stream().map(GeoRadiusResponse::getRawScore).collect(Collectors.toList()),
        contains(0L));
  }
  ...
  public void geosearch() {
    ...
    MatcherAssert.assertThat(members4.get().stream().map(GeoRadiusResponse::getCoordinate).collect(Collectors.toList()),
        Matchers.contains(
            GeoCoordinateMatcher.atCoordinates(2.1909389952632d, 41.433791470673d), GeoCoordinateMatcher.atCoordinates(2.1873744593677d, 41.406342043777d)));
    assertThat(members4.get().stream().map(GeoRadiusResponse::getRawScore).collect(Collectors.toList()),
    ...
    MatcherAssert.assertThat(members8.get().stream().map(GeoRadiusResponse::getCoordinate).collect(Collectors.toList()),
        Matchers.contains(GeoCoordinateMatcher.atCoordinates(2.1909389952632d, 41.433791470673d)));
