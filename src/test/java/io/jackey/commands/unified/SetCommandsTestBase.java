...
public abstract class SetCommandsTestBase extends UnifiedJedisCommandsTestBase {
  ...
  public void spopWithCount() {
    ...
    AssertUtil.assertCollectionContainsAll(superSet, members);
    ...
    AssertUtil.assertByteArrayCollectionContainsAll(bsuperSet, bmembers);
    ByteArrayUtil.byteArrayCollectionRemoveAll(bsuperSet, bmembers);

    bmembers = jedis.spop(bfoo, 2);
    assertEquals(1, bmembers.size());
    AssertUtil.assertByteArraySetEquals(bsuperSet, bmembers);
  ...
  public void sdiffstore() {
    ...
    AssertUtil.assertByteArraySetEquals(bexpected, jedis.smembers("tar".getBytes()));
