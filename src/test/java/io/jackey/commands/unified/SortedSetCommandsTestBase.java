...
public abstract class SortedSetCommandsTestBase extends UnifiedJedisCommandsTestBase {
  ...
  public void zaddWithParams() {
    ...
    Assert.assertEquals(0L, jedis.zadd("foo", 1d, "a", ZAddParams.zAddParams().xx()));

    jedis.zadd("foo", 1d, "a");
    // nx: never update current member
    Assert.assertEquals(0L, jedis.zadd("foo", 2d, "a", ZAddParams.zAddParams().nx()));
    ...
    Assert.assertEquals(2L, jedis.zadd("foo", scoreMembers, ZAddParams.zAddParams().ch()));
    ...
    // xx: never add new member
    Assert.assertEquals(0L, jedis.zadd(bfoo, 1d, ba, ZAddParams.zAddParams().xx()));

    jedis.zadd(bfoo, 1d, ba);
    // nx: never update current member
    Assert.assertEquals(0L, jedis.zadd(bfoo, 2d, ba, ZAddParams.zAddParams().nx()));
    ...
    // ch: return count of members not only added, but also updated
    Assert.assertEquals(2L, jedis.zadd(bfoo, binaryScoreMembers, ZAddParams.zAddParams().ch()));
  ...
  public void zrangeByLexBinary() {
    ...
    AssertUtil.assertByteArrayListEquals(bExpected, jedis.zrangeByLex(bfoo, bInclusiveB, bExclusiveC));
    ...
    // with LIMIT
    AssertUtil.assertByteArrayListEquals(bExpected, jedis.zrangeByLex(bfoo, bLexMinusInf, bLexPlusInf, 0, 2));
  }
  ...
  public void zrevrangeByLexBinary() {
    ...
    AssertUtil.assertByteArrayListEquals(bExpected, jedis.zrevrangeByLex(bfoo, bExclusiveC, bInclusiveB));
    ...
    // with LIMIT
    AssertUtil.assertByteArrayListEquals(bExpected, jedis.zrevrangeByLex(bfoo, bLexPlusInf, bLexMinusInf, 0, 2));
  }
  ...
  public void zrangeParams() {
    ...
    Assert.assertEquals(expected, jedis.zrange("foo", ZRangeParams.zrangeByLexParams("[c", "(aa").rev()));
    ...
    AssertUtil.assertByteArrayListEquals(bExpected, jedis.zrange(bfoo, ZRangeParams.zrangeByLexParams(bExclusiveC, bInclusiveB).rev()));
  ...
  public void zrem() {
    ...
    AssertUtil.assertByteArrayListEquals(bexpected, jedis.zrange(bfoo, 0, 100));
  ...
  public void zpopmin() {
    ...
    Assert.assertEquals(new Tuple("b", 10d), jedis.zpopmin("foo"));
    ...
    Assert.assertEquals(new Tuple(bb, 10d), jedis.zpopmin(bfoo));
  }
  ...
  public void zrangebyscore() {
    ...
    AssertUtil.assertByteArrayListEquals(bexpected, brange2);
  ...
  public void zremrangeByLexBinary() {
    ...
    AssertUtil.assertByteArrayListEquals(bexpected, jedis.zrangeByLex(bfoo, bLexMinusInf, bLexPlusInf));
  }
  ...
  public void zunion() {
    ...
    expected.add("a");
    expected.add("b");
    Assert.assertEquals(expected, jedis.zunion(params, "foo", "bar"));
  ...
  public void zunionstoreParams() {
    ...
    Assert.assertEquals(2, jedis.zunionstore(SafeEncoder.encode("dst"), bparams, bfoo, bbar));
  ...
  public void zinter() {
    ...
    params.weights(2, 2.5);
    params.aggregate(ZParams.Aggregate.SUM);
    Assert.assertEquals(singletonList("a"), jedis.zinter(params, "foo", "bar"));
  ...
  public void zintertoreParams() {
    ...
    Assert.assertEquals(1, jedis.zinterstore(SafeEncoder.encode("dst"), bparams, bfoo, bbar));
  ...
  public void bzpopmax() {
    ...
    Assert.assertEquals(new KeyValue<>("foo", new Tuple("b", 10d)), jedis.bzpopmax(0, "foo", "bar"));
  ...
  public void bzpopmin() {
    ...
    jedis.zadd("foo", 10d, "b", ZAddParams.zAddParams().nx());
    jedis.zadd("bar", 0.1d, "c", ZAddParams.zAddParams().nx());
    Assert.assertEquals(new KeyValue<>("bar", new Tuple("c", 0.1)), jedis.bzpopmin(0, "bar", "foo"));
