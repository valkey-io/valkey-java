package io.jackey.modules.timeseries;
...
import io.jackey.timeseries.DuplicatePolicy;
...
//  }
  ...
  public void testCreate() {
    ...
    Assert.assertEquals("OK", client.tsCreate("series1", TSCreateParams.createParams().retention(10).labels(labels)));
    Assert.assertEquals("TSDB-TYPE", client.type("series1"));

    Assert.assertEquals("OK", client.tsCreate("series2", TSCreateParams.createParams().labels(labels)));
    Assert.assertEquals("TSDB-TYPE", client.type("series2"));

    Assert.assertEquals("OK", client.tsCreate("series3", TSCreateParams.createParams().retention(10)));
    Assert.assertEquals("TSDB-TYPE", client.type("series3"));

    Assert.assertEquals("OK", client.tsCreate("series4"));
    Assert.assertEquals("TSDB-TYPE", client.type("series4"));

    Assert.assertEquals("OK", client.tsCreate("series5", TSCreateParams.createParams().retention(0).uncompressed().labels(labels)));
    Assert.assertEquals("TSDB-TYPE", client.type("series5"));
    Assert.assertEquals("OK", client.tsCreate("series6", TSCreateParams.createParams().retention(7898)
        .uncompressed().duplicatePolicy(DuplicatePolicy.MAX).labels(labels)));
    Assert.assertEquals("TSDB-TYPE", client.type("series6"));
    ...
    try {
      Assert.assertEquals("OK", client.tsCreate("series1", TSCreateParams.createParams().labels(labels)));
      fail();
    } catch (JedisDataException e) {
    }

    try {
      Assert.assertEquals("OK", client.tsCreate("series1", TSCreateParams.createParams().retention(10)));
      fail();
    } catch (JedisDataException e) {
    }

    try {
      Assert.assertEquals("OK", client.tsCreate("series1"));
      fail();
    } catch (JedisDataException e) {
    }
    ...
    try {
      Assert.assertEquals("OK", client.tsCreate("series7", TSCreateParams.createParams().retention(7898)
  ...
  public void testAlter() {
    ...
    labels.put("l1", "v1");
    labels.put("l2", "v2");
    Assert.assertEquals("OK", client.tsCreate("seriesAlter", TSCreateParams.createParams().retention(60000).labels(labels)));
    Assert.assertEquals(Collections.emptyList(), client.tsQueryIndex("l2=v22"));

    labels.put("l1", "v11");
    labels.remove("l2");
    labels.put("l3", "v33");
    Assert.assertEquals("OK", client.tsAlter("seriesAlter", TSAlterParams.alterParams().retention(15000).chunkSize(8192)
  ...
  public void testRule() {
    Assert.assertEquals("OK", client.tsCreate("source"));
    Assert.assertEquals("OK", client.tsCreate("dest", TSCreateParams.createParams().retention(10)));

    Assert.assertEquals("OK", client.tsCreateRule("source", "dest", AggregationType.AVG, 100));
    ...
    Assert.assertEquals("OK", client.tsDeleteRule("source", "dest"));
    Assert.assertEquals("OK", client.tsCreateRule("source", "dest", AggregationType.COUNT, 100));

    try {
      Assert.assertEquals("OK", client.tsDeleteRule("source", "dest1"));
      fail();
    } catch (JedisDataException e) {
      // Error on creating same rule twice
    }
  ...
  public void testAdd() {
    ...
    labels.put("l1", "v1");
    labels.put("l2", "v2");
    Assert.assertEquals("OK", client.tsCreate("seriesAdd", TSCreateParams.createParams().retention(10000).labels(labels)));
    Assert.assertEquals(0, client.tsRange("seriesAdd", TSRangeParams.rangeParams()).size());

    Assert.assertEquals(1000L, client.tsAdd("seriesAdd", 1000L, 1.1, TSCreateParams.createParams().retention(10000).labels(null)));
    Assert.assertEquals(2000L, client.tsAdd("seriesAdd", 2000L, 0.9, TSCreateParams.createParams().labels(null)));
    Assert.assertEquals(3200L, client.tsAdd("seriesAdd", 3200L, 1.1, TSCreateParams.createParams().retention(10000)));
    Assert.assertEquals(4500L, client.tsAdd("seriesAdd", 4500L, -1.1));
    ...
    Assert.assertEquals(Arrays.asList(rawValues), client.tsRange("seriesAdd", TSRangeParams.rangeParams()));
    ...
    // MRANGE
    Assert.assertEquals(Collections.emptyMap(), client.tsMRange(TSMRangeParams.multiRangeParams().filter("l=v")));
    try {
...
//    } catch (JedisDataException e) {
    ...
    labels2.put("l3", "v3");
    labels2.put("l4", "v4");
    Assert.assertEquals(1000L, client.tsAdd("seriesAdd2", 1000L, 1.1, TSCreateParams.createParams().retention(10000).labels(labels2)));
    ...
    AssertUtil.assertEqualsByProtocol(protocol, null, Arrays.asList(AggregationType.COUNT), elements2.getAggregators());

    Map<String, String> labels3 = new HashMap<>();
    labels3.put("l3", "v33");
    labels3.put("l4", "v4");
    Assert.assertEquals(1000L, client.tsAdd("seriesAdd3", 1000L, 1.1, TSCreateParams.createParams().labels(labels3)));
    Assert.assertEquals(2000L, client.tsAdd("seriesAdd3", 2000L, 1.1, TSCreateParams.createParams().labels(labels3)));
    Assert.assertEquals(3000L, client.tsAdd("seriesAdd3", 3000L, 1.1, TSCreateParams.createParams().labels(labels3)));
    ...
    AssertUtil.assertEqualsByProtocol(protocol, null, Arrays.asList(AggregationType.AVG), ranges3List.get(0).getAggregators());
    assertEquals(2, ranges3List.get(1).getValue().size());
    assertEquals(labels3, ranges3List.get(1).getLabels());
    AssertUtil.assertEqualsByProtocol(protocol, null, Arrays.asList(AggregationType.AVG), ranges3List.get(1).getAggregators());

    Assert.assertEquals(800L, client.tsAdd("seriesAdd", 800L, 1.1));
    Assert.assertEquals(700L, client.tsAdd("seriesAdd", 700L, 1.1, TSCreateParams.createParams().retention(10000)));
    Assert.assertEquals(600L, client.tsAdd("seriesAdd", 600L, 1.1, TSCreateParams.createParams().retention(10000).labels(null)));

    Assert.assertEquals(400L, client.tsAdd("seriesAdd4", 400L, 0.4, TSCreateParams.createParams()
        .retention(7898L).uncompressed().chunkSize(1000L).duplicatePolicy(DuplicatePolicy.SUM)
        .labels(labels)));
    Assert.assertEquals("TSDB-TYPE", client.type("seriesAdd4"));
    Assert.assertEquals(400L, client.tsAdd("seriesAdd4", 400L, 0.3, TSCreateParams.createParams()
        .retention(7898L).uncompressed().chunkSize(1000L).duplicatePolicy(DuplicatePolicy.SUM)
        .labels(labels)));
    Assert.assertEquals(Arrays.asList(new TSElement(400L, 0.7)), client.tsRange("seriesAdd4", 0L, Long.MAX_VALUE));
  ...
  public void del() {
    ...
    Assert.assertEquals("OK", client.tsCreate("ts-del", TSCreateParams.createParams().retention(10000L)));
    Assert.assertEquals(0, client.tsDel("ts-del", 0, 1));

    Assert.assertEquals(1000L, client.tsAdd("ts-del", 1000L, 1.1, TSCreateParams.createParams().retention(10000)));
    Assert.assertEquals(2000L, client.tsAdd("ts-del", 2000L, 0.9));
    Assert.assertEquals(3200L, client.tsAdd("ts-del", 3200L, 1.1, TSCreateParams.createParams().retention(10000)));
    Assert.assertEquals(4500L, client.tsAdd("ts-del", 4500L, -1.1));
    Assert.assertEquals(4, client.tsRange("ts-del", 0, 5000).size());

    Assert.assertEquals(2, client.tsDel("ts-del", 2000, 4000));
    Assert.assertEquals(2, client.tsRange("ts-del", 0, 5000).size());
    Assert.assertEquals(1, client.tsRange("ts-del", 0, 2500).size());
    Assert.assertEquals(1, client.tsRange("ts-del", 2500, 5000).size());
  }
...
//    assertEquals(-1856758940, v.hashCode());
  ...
  public void testAddStar() throws InterruptedException {
    ...
    labels.put("l11", "v11");
    labels.put("l22", "v22");
    Assert.assertEquals("OK", client.tsCreate("seriesAdd2", TSCreateParams.createParams().retention(10000L).labels(labels)));
...
//    long add1 = client.tsAdd("seriesAdd2", 1.1, 10000);
  ...
  public void testMadd() {
    ...
    labels.put("l1", "v1");
    labels.put("l2", "v2");
    Assert.assertEquals("OK", client.tsCreate("seriesAdd1", TSCreateParams.createParams().retention(10000L).labels(labels)));
    Assert.assertEquals("OK", client.tsCreate("seriesAdd2", TSCreateParams.createParams().retention(10000L).labels(labels)));
  ...
  public void testIncrByDecrBy() throws InterruptedException {
    Assert.assertEquals("OK", client.tsCreate("seriesIncDec",
        TSCreateParams.createParams().retention(100 * 1000 /*100 sec*/)));

    Assert.assertEquals(1L, client.tsAdd("seriesIncDec", 1L, 1), 0);
    Assert.assertEquals(2L, client.tsIncrBy("seriesIncDec", 3, 2L), 0);
    Assert.assertEquals(3L, client.tsDecrBy("seriesIncDec", 2, 3L), 0);
...
//        .groupByReduce("metric_name", "max"), "metric=cpu");
  ...
  public void testGet() {
    ...
    Assert.assertEquals("OK", client.tsCreate("seriesGet", TSCreateParams.createParams()
    ...
    Assert.assertEquals(new TSElement(2558, 8.7), client.tsGet("seriesGet"));

    client.tsAdd("seriesGet", 3458, 1.117);
    Assert.assertEquals(new TSElement(3458, 1.117), client.tsGet("seriesGet"));
  }
  ...
  public void testMGet() {
    ...
    labels.put("l1", "v1");
    labels.put("l2", "v2");
    Assert.assertEquals("OK", client.tsCreate("seriesMGet1", TSCreateParams.createParams()
        .retention(100 * 1000 /*100sec retentionTime*/).labels(labels)));
    Assert.assertEquals("OK", client.tsCreate("seriesMGet2", TSCreateParams.createParams()
        .retention(100 * 1000 /*100sec retentionTime*/).labels(labels)));
    ...
    Assert.assertEquals(new TSElement(1500, 1.3), ranges3List.get(0).getValue());
  ...
  public void testQueryIndex() {
    ...
    labels.put("l1", "v1");
    labels.put("l2", "v2");
    Assert.assertEquals("OK", client.tsCreate("seriesQueryIndex1", TSCreateParams.createParams()
        .retention(100 * 1000 /*100sec retentionTime*/).labels(labels)));

    labels.put("l2", "v22");
    labels.put("l3", "v33");
    Assert.assertEquals("OK", client.tsCreate("seriesQueryIndex2", TSCreateParams.createParams()
        .retention(100 * 1000 /*100sec retentionTime*/).labels(labels)));

    Assert.assertEquals(Arrays.<String>asList(), client.tsQueryIndex("l1=v2"));
    Assert.assertEquals(Arrays.asList("seriesQueryIndex1", "seriesQueryIndex2"), client.tsQueryIndex("l1=v1"));
    Assert.assertEquals(Arrays.asList("seriesQueryIndex2"), client.tsQueryIndex("l2=v22"));
  }
  ...
  public void testInfo() {
    ...
    labels.put("l1", "v1");
    labels.put("l2", "v2");
    Assert.assertEquals("OK", client.tsCreate("source", TSCreateParams.createParams().retention(10000L).labels(labels)));
    Assert.assertEquals("OK", client.tsCreate("dest", TSCreateParams.createParams().retention(20000L)));
    Assert.assertEquals("OK", client.tsCreateRule("source", "dest", AggregationType.AVG, 100));
  ...
  public void testInfoDebug() {
    Assert.assertEquals("OK", client.tsCreate("source", TSCreateParams.createParams()));
  ...
  public void testRevRange() {
    ...
    labels.put("l1", "v1");
    labels.put("l2", "v2");
    Assert.assertEquals("OK", client.tsCreate("seriesAdd", TSCreateParams.createParams().retention(10000L).labels(labels)));
    Assert.assertEquals(Collections.emptyList(), client.tsRevRange("seriesAdd", TSRangeParams.rangeParams()));

    Assert.assertEquals(1000L, client.tsAdd("seriesRevRange", 1000L, 1.1, TSCreateParams.createParams().retention(10000)));
    Assert.assertEquals(2000L, client.tsAdd("seriesRevRange", 2000L, 0.9, TSCreateParams.createParams().labels(null)));
    Assert.assertEquals(3200L, client.tsAdd("seriesRevRange", 3200L, 1.1, TSCreateParams.createParams().retention(10000)));
    Assert.assertEquals(4500L, client.tsAdd("seriesRevRange", 4500L, -1.1));
    ...
    assertEquals(4, values.size());
    assertEquals(Arrays.asList(rawValues), values);
    Assert.assertEquals(Arrays.asList(rawValues), client.tsRevRange("seriesRevRange", TSRangeParams.rangeParams()));
  ...
  public void testMRevRange() {
    ...
    Assert.assertEquals(Collections.emptyMap(), client.tsMRevRange(TSMRangeParams.multiRangeParams().filter("l=v")));

    Map<String, String> labels1 = new HashMap<>();
    labels1.put("l3", "v3");
    labels1.put("l4", "v4");
    Assert.assertEquals(1000L, client.tsAdd("seriesMRevRange1", 1000L, 1.1,
        TSCreateParams.createParams().retention(10000).labels(labels1)));
    Assert.assertEquals(2222L, client.tsAdd("seriesMRevRange1", 2222L, 3.1,
        TSCreateParams.createParams().retention(10000).labels(labels1)));
    ...
    labels2.put("l3", "v3");
    labels2.put("l4", "v44");
    Assert.assertEquals(1000L, client.tsAdd("seriesMRevRange2", 1000L, 8.88,
        TSCreateParams.createParams().retention(10000).labels(labels2)));
    Assert.assertEquals(1111L, client.tsAdd("seriesMRevRange2", 1111L, 99.99,
        TSCreateParams.createParams().retention(10000).labels(labels2)));
    ...
    labels3.put("l3", "v33");
    labels3.put("l4", "v4");
    Assert.assertEquals(2200L, client.tsAdd("seriesMRevRange3", 2200L, -1.1, TSCreateParams.createParams().labels(labels3)));
    Assert.assertEquals(2400L, client.tsAdd("seriesMRevRange3", 2400L, 1.1, TSCreateParams.createParams().labels(labels3)));
    Assert.assertEquals(3300L, client.tsAdd("seriesMRevRange3", 3300L, -33, TSCreateParams.createParams().labels(labels3)));
  ...
  public void latest() {
    ...
    // get
    Assert.assertEquals(compact, client.tsGet("ts2", TSGetParams.getParams()));

    Assert.assertEquals(latest, client.tsGet("ts2", TSGetParams.getParams().latest()));

    // range
    Assert.assertEquals(Arrays.asList(compact), client.tsRange("ts2", TSRangeParams.rangeParams(0, 10)));

    Assert.assertEquals(Arrays.asList(compact, latest), client.tsRange("ts2", TSRangeParams.rangeParams(0, 10).latest()));

    // revrange
    Assert.assertEquals(Arrays.asList(compact), client.tsRevRange("ts2", TSRangeParams.rangeParams(0, 10)));

    Assert.assertEquals(Arrays.asList(latest, compact), client.tsRevRange("ts2", TSRangeParams.rangeParams(0, 10).latest()));
  }
  ...
  public void latestMulti() {
    ...
    // mget
    Assert.assertEquals(makeSingletonMap(new TSMGetElement("ts2", null, compact)),
        client.tsMGet(TSMGetParams.multiGetParams(), "compact=true"));

    Assert.assertEquals(makeSingletonMap(new TSMGetElement("ts2", null, latest)),
        client.tsMGet(TSMGetParams.multiGetParams().latest(), "compact=true"));

    // mrange
    Assert.assertEquals(makeSingletonMap(new TSMRangeElements("ts2", null, Arrays.asList(compact))),
        client.tsMRange(TSMRangeParams.multiRangeParams().filter("compact=true")));

    Assert.assertEquals(makeSingletonMap(new TSMRangeElements("ts2", null, Arrays.asList(compact, latest))),
    ...
    Assert.assertEquals(makeSingletonMap(new TSMRangeElements("ts2", null, Arrays.asList(latest, compact))),
  ...
  public void bucketTimestamp() {
    ...
    // range / revrange
    Assert.assertEquals(0, client.tsRange("ts", TSRangeParams.rangeParams()
        .aggregation(AggregationType.FIRST, 10).bucketTimestampLow()).get(0).getTimestamp());
    Assert.assertEquals(10, client.tsRange("ts", TSRangeParams.rangeParams()
        .aggregation(AggregationType.LAST, 10).bucketTimestampHigh()).get(0).getTimestamp());
    Assert.assertEquals(5, client.tsRange("ts", TSRangeParams.rangeParams()
        .aggregation(AggregationType.RANGE, 10).bucketTimestampMid()).get(0).getTimestamp());
    Assert.assertEquals(5, client.tsRevRange("ts", TSRangeParams.rangeParams()
    ...
    // mrange / mrevrange
    Assert.assertEquals(0, client.tsMRange(TSMRangeParams.multiRangeParams()
        .aggregation(AggregationType.STD_P, 10).bucketTimestampLow().filter("l=v"))
        .values().stream().findAny().get().getValue().get(0).getTimestamp());
    Assert.assertEquals(10, client.tsMRange(TSMRangeParams.multiRangeParams()
        .aggregation(AggregationType.STD_S, 10).bucketTimestampHigh().filter("l=v"))
        .values().stream().findAny().get().getValue().get(0).getTimestamp());
    Assert.assertEquals(5, client.tsMRange(TSMRangeParams.multiRangeParams()
  ...
  public void alignTimestamp() {
    ...
    Assert.assertEquals(2, client.tsRange("ts2", TSRangeParams.rangeParams().aggregation(AggregationType.COUNT, 10)).size());
    Assert.assertEquals(1, client.tsRange("ts3", TSRangeParams.rangeParams().aggregation(AggregationType.COUNT, 10)).size());
  }
}
