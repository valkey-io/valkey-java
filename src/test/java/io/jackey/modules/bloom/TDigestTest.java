...
//  }
  ...
  public void createSimple() {
    Assert.assertEquals("OK", client.tdigestCreate("td-simple"));
  ...
  public void createAndInfo() {
    for (int i = 100; i < 1000; i += 100) {
      String key = "td-" + i;
      Assert.assertEquals("OK", client.tdigestCreate(key, i));
  ...
  public void reset() {
    ...
    // on empty
    Assert.assertEquals("OK", client.tdigestReset("reset"));
    assertMergedUnmergedNodes("reset", 0, 0);
...
//    assertEquals("OK", client.tdigestAdd("tdadd", randomValueWeight()));
    Assert.assertEquals("OK", client.tdigestAdd("tdadd", randomValue()));
...
//    assertEquals("OK", client.tdigestAdd("tdadd", randomValueWeight(), randomValueWeight(), randomValueWeight(), randomValueWeight()));
    Assert.assertEquals("OK", client.tdigestAdd("tdadd", randomValue(), randomValue(), randomValue(), randomValue()));
  ...
  public void merge() {
    ...
    Assert.assertEquals("OK", client.tdigestMerge("td2", "td4m"));
...
//    client.tdigestAdd("from2", KeyValue.of(1d, 10l));
    ...
    Assert.assertEquals("OK", client.tdigestMerge("to", "from1", "from2"));
    assertTotalWeight("to", 11l);

    Assert.assertEquals("OK", client.tdigestMerge(TDigestMergeParams.mergeParams()
        .compression(50).override(), "to", "from1", "from2"));
    Assert.assertEquals(Long.valueOf(50), client.tdigestInfo("to").get("Compression"));
  }

  @Test
  public void cdf() {
    client.tdigestCreate("tdcdf", 100);
    Assert.assertEquals(singletonList(Double.NaN), client.tdigestCDF("tdcdf", 50));
...
//    client.tdigestAdd("tdcdf", definedValueWeight(100, 1), definedValueWeight(100, 1));
    ...
    Assert.assertEquals(singletonList(0.6), client.tdigestCDF("tdcdf", 50));
  ...
  public void quantile() {
    ...
    Assert.assertEquals(singletonList(Double.NaN), client.tdigestQuantile("tdqnt", 0.5));
...
//    client.tdigestAdd("tdqnt", definedValueWeight(100, 1), definedValueWeight(100, 1));
    ...
    Assert.assertEquals(singletonList(1.0), client.tdigestQuantile("tdqnt", 0.5));
  }
  ...
  public void minAndMax() {
    ...
    Assert.assertEquals(Double.NaN, client.tdigestMin(key), 0d);
    Assert.assertEquals(Double.NaN, client.tdigestMax(key), 0d);
...
//    client.tdigestAdd(key, definedValueWeight(5, 1));
    ...
    Assert.assertEquals(2d, client.tdigestMin(key), 0.01);
    Assert.assertEquals(5d, client.tdigestMax(key), 0.01);
  }
...
//      client.tdigestAdd(key, KeyValue.of(Double.valueOf(i), 1l));
    ...
    Assert.assertEquals(9.5, client.tdigestTrimmedMean(key, 0.1, 0.9), 0.01);
    Assert.assertEquals(9.5, client.tdigestTrimmedMean(key, 0.0, 1.0), 0.01);
    Assert.assertEquals(4.5, client.tdigestTrimmedMean(key, 0.0, 0.5), 0.01);
    Assert.assertEquals(14.5, client.tdigestTrimmedMean(key, 0.5, 1.0), 0.01);
  }
  ...
  public void rankCommands() {
    ...
    Assert.assertEquals(Arrays.asList(0l, 2l), client.tdigestRank(key, 2d, 4d));
    Assert.assertEquals(Arrays.asList(0l, 1l), client.tdigestRevRank(key, 5d, 4d));
    Assert.assertEquals(Arrays.asList(2d, 3d), client.tdigestByRank(key, 0l, 1l));
    Assert.assertEquals(Arrays.asList(5d, 3d), client.tdigestByRevRank(key, 0l, 1l));
  }
//
