...
import io.jackey.args.SortingOrder;
...
import io.jackey.search.FtSearchIteration;
import io.jackey.search.IndexDataType;
import io.jackey.search.RediSearchUtil;
import io.jackey.search.SearchResult;
import io.jackey.search.schemafields.GeoField;
import io.jackey.search.schemafields.GeoShapeField;
...
import io.jackey.search.schemafields.VectorField;
import io.jackey.search.schemafields.VectorField.VectorAlgorithm;
...
import io.jackey.search.schemafields.*;
...
//  }
  ...
  @Test
  public void create() {
    AssertUtil.assertOK(client.ftCreate(index,
  ...
  public void alterAdd() {
    AssertUtil.assertOK(client.ftCreate(index, TextField.of("title")));
    ...
    AssertUtil.assertOK(client.ftAlter(index,
        TagField.of("tags"),
  ...
  public void search() {
    ...
    Assert.assertEquals("OK", client.ftDropIndex(index));
    try {
  ...
  public void numericFilter() {
    AssertUtil.assertOK(client.ftCreate(index, TextField.of("title"), NumericField.of("price")));
  ...
  public void noStopwords() {
    ...
    Assert.assertEquals(1, client.ftSearch(index, "hello world").getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, "foo bar").getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, "to be or not to be").getTotalResults());
  }

  @Test
  public void geoFilter() {
    AssertUtil.assertOK(client.ftCreate(index, TextField.of("title"), GeoField.of("loc")));
  ...
  public void geoShapeFilterSpherical() throws ParseException {
    ...
    AssertUtil.assertOK(client.ftCreate(index, GeoShapeField.of("geom", GeoShapeField.CoordinateSystem.SPHERICAL)));
  ...
  public void geoShapeFilterFlat() throws ParseException {
    ...
    AssertUtil.assertOK(client.ftCreate(index, GeoShapeField.of("geom", GeoShapeField.CoordinateSystem.FLAT)));
...
//    }
  ...
  public void testQueryParams() {
    AssertUtil.assertOK(client.ftCreate(index, NumericField.of("numval")));

    client.hset("1", "numval", "1");
    client.hset("2", "numval", "2");
    client.hset("3", "numval", "3");

    Assert.assertEquals(2, client.ftSearch(index, "@numval:[$min $max]",
  ...
  public void testSortQueryFlags() {
    AssertUtil.assertOK(client.ftCreate(index, TextField.of("title").sortable()));
  ...
  public void dropIndex() {
    ...
    Assert.assertEquals(100, client.dbSize());
  }
  ...
  public void dropIndexDD() {
    ...
    Assert.assertEquals("OK", client.ftDropIndexDD(index));

    Set<String> keys = client.keys("*");
    assertTrue(keys.isEmpty());
    Assert.assertEquals(0, client.dbSize());
  }

  @Test
  public void noStem() {
    AssertUtil.assertOK(client.ftCreate(index, new TextField("stemmed").weight(1.0),
  ...
  public void phoneticMatch() {
    AssertUtil.assertOK(client.ftCreate(index, new TextField("noPhonetic").weight(1.0),
  ...
  public void info() {
    ...
    AssertUtil.assertOK(client.ftCreate(index, sc));
  ...
  public void noIndexAndSortBy() {
    AssertUtil.assertOK(client.ftCreate(index, TextField.of("f1").sortable().noIndex(), TextField.of("f2")));
  ...
  public void testHighlightSummarize() {
    AssertUtil.assertOK(client.ftCreate(index, TextField.of("text").weight(1)));
  ...
  public void getTagField() {
    AssertUtil.assertOK(client.ftCreate(index, TextField.of("title"), TagField.of("category")));
    ...
    Assert.assertEquals(1, client.ftSearch(index, "@category:{red}").getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, "@category:{blue}").getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, "hello @category:{red}").getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, "hello @category:{blue}").getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, "@category:{yellow}").getTotalResults());
    Assert.assertEquals(0, client.ftSearch(index, "@category:{purple}").getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, "@category:{orange\\;purple}").getTotalResults());
    Assert.assertEquals(4, client.ftSearch(index, "hello").getTotalResults());

    Assert.assertEquals(new HashSet<>(Arrays.asList("red", "blue", "green", "yellow", "orange;purple")),
  ...
  public void testGetTagFieldWithNonDefaultSeparator() {
    ...
    Assert.assertEquals(1, client.ftSearch(index, "hello @category:{red}").getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, "hello @category:{blue}").getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, "hello @category:{yellow}").getTotalResults());
    Assert.assertEquals(0, client.ftSearch(index, "@category:{purple}").getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, "@category:{orange\\,purple}").getTotalResults());
    Assert.assertEquals(4, client.ftSearch(index, "hello").getTotalResults());
  ...
  public void caseSensitiveTagField() {
    ...
    Assert.assertEquals(0, client.ftSearch(index, "@category:{redx}").getTotalResults());
    Assert.assertEquals(0, client.ftSearch(index, "@category:{redX}").getTotalResults());
    Assert.assertEquals(0, client.ftSearch(index, "@category:{Redx}").getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, "@category:{RedX}").getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, "hello").getTotalResults());
  }

  @Test
  public void testReturnFields() {
    AssertUtil.assertOK(client.ftCreate(index, TextField.of("field1"), TextField.of("field2")));
  ...
  public void returnWithFieldNames() {
    AssertUtil.assertOK(client.ftCreate(index, TextField.of("a"), TextField.of("b"), TextField.of("c")));
  ...
  @Test
  public void alias() {
    AssertUtil.assertOK(client.ftCreate(index, TextField.of("field1")));

    Map<String, Object> doc = new HashMap<>();
    doc.put("field1", "value");
    addDocument("doc1", doc);

    Assert.assertEquals("OK", client.ftAliasAdd("ALIAS1", index));
    ...
    Assert.assertEquals("OK", client.ftAliasUpdate("ALIAS2", index));
    ...
    Assert.assertEquals("OK", client.ftAliasDel("ALIAS2"));
    try {
  ...
  @Test
  public void synonym() {
    AssertUtil.assertOK(client.ftCreate(index, TextField.of("name").weight(1), TextField.of("addr").weight(1)));

    long group1 = 345L;
    long group2 = 789L;
    String group1_str = Long.toString(group1);
    String group2_str = Long.toString(group2);
    Assert.assertEquals("OK", client.ftSynUpdate(index, group1_str, "girl", "baby"));
    Assert.assertEquals("OK", client.ftSynUpdate(index, group1_str, "child"));
    Assert.assertEquals("OK", client.ftSynUpdate(index, group2_str, "child"));
  ...
  public void testHNSWVVectorSimilarity() {
    ...
    AssertUtil.assertOK(client.ftCreate(index, VectorField.builder().fieldName("v")
  ...
  public void searchProfile() {
    AssertUtil.assertOK(client.ftCreate(index, TextField.of("t1"), TextField.of("t2")));
  ...
  public void maxPrefixExpansionSearchProfile() {
    ...
    try {
      ...
      AssertUtil.assertOK(client.ftCreate(index, TextField.of("t")));
  ...
  @Test
  public void list() {
    Assert.assertEquals(Collections.emptySet(), client.ftList());

    final int count = 20;
    Set<String> names = new HashSet<>();
    for (int i = 0; i < count; i++) {
      final String name = "idx" + i;
      AssertUtil.assertOK(client.ftCreate(name, TextField.of("t" + i)));
      names.add(name);
    }
    Assert.assertEquals(names, client.ftList());
  }

  @Test
  public void broadcast() {
    String reply = client.ftCreate(index, TextField.of("t"));
    AssertUtil.assertOK(reply);
  }
  ...
  public void escapeUtil() {
    AssertUtil.assertOK(client.ftCreate(index, TextField.of("txt")));

    client.hset("doc1", "txt", RediSearchUtil.escape("hello-world"));
    Assert.assertNotEquals("hello-world", client.hget("doc1", "txt"));
  ...
  public void escapeMapUtil() {
    ...
    Assert.assertNotEquals("hello-world", client.hget("doc2", "txt"));
  ...
  public void hsetObject() {
    ...
    Assert.assertEquals(1L, client.hsetObject("obj", "floats", floats));
    Assert.assertArrayEquals(RediSearchUtil.toByteArray(floats),
    ...
    fields.put("title", "hello world");
    fields.put("loc", geo);
    Assert.assertEquals(2L, client.hsetObject("obj", fields));
