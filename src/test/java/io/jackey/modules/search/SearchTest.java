...
import io.jackey.search.IndexDefinition;
...
import io.jackey.search.Schema.TagField;
import io.jackey.search.Schema.TextField;
...
//    assertTrue(client.addDocument("doc1", fields));
  ...
  public void noStopwords() throws Exception {
    ...
    Assert.assertEquals(1, client.ftSearch(index, new Query("hello world")).getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, new Query("foo bar")).getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, new Query("to be or not to be")).getTotalResults());
  }
...
//      assertNotEquals(1.0, d.getScore());
  ...
  public void testQueryParams() {
    ...
    Assert.assertEquals(2, client.ftSearch(index, query).getTotalResults());
  }
...
//    assertTrue(client.addDocument("qux", fields4));
    ...
    Assert.assertEquals(1, client.ftSearch(index, new Query("@category:{red}")).getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, new Query("@category:{blue}")).getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, new Query("hello @category:{red}")).getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, new Query("hello @category:{blue}")).getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, new Query("@category:{yellow}")).getTotalResults());
    Assert.assertEquals(0, client.ftSearch(index, new Query("@category:{purple}")).getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, new Query("@category:{orange\\;purple}")).getTotalResults());
    Assert.assertEquals(4, client.ftSearch(index, new Query("hello")).getTotalResults());
...
//    assertTrue(client.addDocument("qux", fields4));
    ...
    Assert.assertEquals(1, client.ftSearch(index, new Query("hello @category:{red}")).getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, new Query("hello @category:{blue}")).getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, new Query("hello @category:{yellow}")).getTotalResults());
    Assert.assertEquals(0, client.ftSearch(index, new Query("@category:{purple}")).getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, new Query("@category:{orange\\,purple}")).getTotalResults());
    Assert.assertEquals(4, client.ftSearch(index, new Query("hello")).getTotalResults());
  ...
  public void caseSensitiveTagField() {
    ...
    Assert.assertEquals(0, client.ftSearch(index, new Query("@category:{redx}")).getTotalResults());
    Assert.assertEquals(0, client.ftSearch(index, new Query("@category:{redX}")).getTotalResults());
    Assert.assertEquals(0, client.ftSearch(index, new Query("@category:{Redx}")).getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, new Query("@category:{RedX}")).getTotalResults());
    Assert.assertEquals(1, client.ftSearch(index, new Query("hello")).getTotalResults());
  }
