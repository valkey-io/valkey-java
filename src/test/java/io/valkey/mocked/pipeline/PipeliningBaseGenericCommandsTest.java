...
public class PipeliningBaseGenericCommandsTest extends PipeliningBaseMockedTestBase {
  ...
  public void testExists() {
    ...
    MatcherAssert.assertThat(commands, Matchers.contains(booleanCommandObject));
    assertThat(result, Matchers.is(predefinedResponse));
  }
  ...
  public void testKeys() {
    ...
    MatcherAssert.assertThat(commands, Matchers.contains(setStringCommandObject));
    assertThat(response, Matchers.is(predefinedResponse));
  }
  ...
  public void testKeysBinary() {
    ...
    MatcherAssert.assertThat(commands, Matchers.contains(setBytesCommandObject));
    assertThat(response, Matchers.is(predefinedResponse));
  }
  ...
  public void testScan() {
    ...
    MatcherAssert.assertThat(commands, Matchers.contains(scanResultStringCommandObject));
    assertThat(response, Matchers.is(predefinedResponse));
  }
  ...
  public void testScanBinary() {
    ...
    MatcherAssert.assertThat(commands, Matchers.contains(scanResultBytesCommandObject));
    assertThat(response, Matchers.is(predefinedResponse));
  }
  ...
  public void testWaitAOF() {
    ...
    MatcherAssert.assertThat(commands, Matchers.contains(keyValueLongLongCommandObject));
    assertThat(response, Matchers.is(predefinedResponse));
  }
